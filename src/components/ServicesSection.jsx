...
const services = [
  {
    ...
    description: "Analiză structurală și proiectare expertă pentru durabilitatea și siguranța clădirilor",
    features: [
  ...
  },
  {
    ...
    description: "Evaluări complete de siguranță și implementări pentru excelență operațională",
    features: [
...
const ServicesSection = () => {
  return (
      <section id="services-section" className="bg-gray-50 py-24">
