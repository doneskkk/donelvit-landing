...
const projects = [
    ...
    },
    {
        ...
        description: "Consultanță tehnică și expertiza pentru un complex rezidențial modern cu 200 de apartamente.",
    ...
    },
    {
        ...
        type: "Medical",
        image: "/api/placeholder/600/400",
        description: "Evaluarea tehnică și consultanță pentru renovarea și modernizarea centrului medical.",
        services: ["Evaluare structurală", "Sisteme medicale", "Siguranță în exploatare"],
        ...
        >
            ...
            <div className="p-6 space-y-4">
                ...
                <div className="border-t pt-4">
                    <h4 className="text-sm font-semibold text-gray-700 mb-2">Servicii Furnizate:</h4>
            ...
            <div className="container mx-auto px-4 max-w-7xl">
                <div className="max-w-3xl mx-auto text-center mb-16">
                    ...
                    <p className="text-gray-600 text-lg leading-relaxed">
                        Portofoliul nostru demonstrează expertiza tehnică și dedicarea pentru excelență
                        în fiecare proiect realizat. Fiecare obiect finalizat reprezintă un angajament
                        pentru calitate și inovație.
                    </p>
                </div>
